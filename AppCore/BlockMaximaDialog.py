...
# Form implementation generated from reading ui file 'C:\Users\georg\Documents\GitHub\PyEVA\QtGUI\BlockMaximaDialog.ui'
#
...
"}"))
        ...
        self.groupBox.setMinimumSize(QtCore.QSize(325, 139))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Lucida Console"))
        font.setPointSize(14)
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "Block Maxima Extractor", None))
        self.label_3.setText(_translate("Dialog", "Time series data", None))
        self.label_4.setText(_translate("Dialog", "Extreme values", None))
        self.groupBox.setTitle(_translate("Dialog", "Extreme values extraction", None))
        self.label_5.setText(_translate("Dialog", "Data column to extract", None))
        self.label.setText(_translate("Dialog", "Block size", None))
        self.comboBox.setItemText(0, _translate("Dialog", "Year", None))
        self.label_2.setText(_translate("Dialog", "Block length", None))
        self.pushButton.setText(_translate("Dialog", "Extract extreme values", None))
